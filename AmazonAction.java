...
public class AmazonAction {
	...
	public static void main(String[] args) {
		...
		a.moveToElement(driver.findElement(By.cssSelector("#twotabsearchtextbox"))).click().keyDown(Keys.SHIFT).sendKeys("i am automating your site").doubleClick().build().perform();
		driver.quit();
